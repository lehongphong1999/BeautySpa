            ...
            <tbody>
              ...
              @if (!is_null($db))
                ...
                <tr>
                    ...
                    <td>
                      {{--  <button style="width: 90px;height: 30px;background: rgb(124, 230, 124) ; color:white ; border: none;border-radius:25rem"><a href="{{  route('showdetailday', ['id'=>$item->id])}}"><i class="nav-icon fas fa-edit" style="margin-right: 4px"></i>Xem</a></button>
                      <button style="width: 80px;height: 30px;background: rgb(124, 230, 124) ; color:white ; border: none;border-radius:25rem"><a href="{{  route('deleterevenue', ['id'=>$item->id])}}"><i class="fa fa-trash" aria-hidden="true" style="margin-right: 4px"></i>Xóa</a></button>
